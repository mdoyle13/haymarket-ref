class Beer < ActiveRecord::Base
  ...
  named_scope :bottles, :conditions => ["bottle_price NOT NULL"]
  named_scope :drafts, :conditions => ["draft_price_4oz NOT NULL OR draft_price_12oz NOT NULL OR draft_price_16oz NOT NULL or draft_price_20oz NOT NULL"]
